...
export interface ApiAuditLogAuditLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accion: Schema.Attribute.Enumeration<
      ['Crear', 'Actualizar', 'Eliminar', 'Enviar_factus', 'Error']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    entidad_id: Schema.Attribute.String;
    ip_addres: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Clientes/Adquirientes para facturaci\u00F3n electr\u00F3nica';
    displayName: 'Client';
    pluralName: 'clients';
    singularName: 'client';
  };
  ...
  attributes: {
    ...
    ciudad_codigo: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 10;
      }>;
    ...
    digito_verificacion: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 1;
      }>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    razon_social: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 255;
      }>;
    regimen_fiscal: Schema.Attribute.Enumeration<
      ['responsable_iva', 'no_responsable_iva', 'gran_contribuyente', 'simple']
    > &
      Schema.Attribute.Required &
    ...
    > &
      Schema.Attribute.Required;
    tipo_persona: Schema.Attribute.Enumeration<['Natural', 'Juridica']> &
      Schema.Attribute.Required &
...
export interface ApiFactusConfigFactusConfig extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'factus-config';
    pluralName: 'factus-configs';
    singularName: 'factus-config';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ambiente: Schema.Attribute.Enumeration<
      ['Produccion', 'Habilitacion', 'Pruebas']
    > &
      Schema.Attribute.DefaultTo<'Produccion'>;
    api_password: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Private;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    empresa_direccion: Schema.Attribute.String;
    empresa_email: Schema.Attribute.Email;
    empresa_nit: Schema.Attribute.String & Schema.Attribute.Required;
    empresa_nombre: Schema.Attribute.String & Schema.Attribute.Required;
    empresa_telefono: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    resolucion_dian: Schema.Attribute.String;
    resolucion_hasta: Schema.Attribute.Integer;
    token_acceso: Schema.Attribute.String & Schema.Attribute.Private;
    token_expiracion: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
  ...
  attributes: {
    cantidad: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    codigo_estandar: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 20;
      }>;
    codigo_estandar_id: Schema.Attribute.Integer &
    ...
    esquema_id: Schema.Attribute.String & Schema.Attribute.DefaultTo<'1'>;
    ico_porcentaje: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    ico_valor: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    invoice: Schema.Attribute.Relation<'manyToOne', 'api::invoice.invoice'>;
    iva_porcentaje: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
    ...
    iva_valor: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    propiedades_adicionales: Schema.Attribute.JSON &
      Schema.Attribute.DefaultTo<[]>;
    publishedAt: Schema.Attribute.DateTime;
    retenciones: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<[]>;
    subtotal: Schema.Attribute.Decimal & Schema.Attribute.Required;
    total_item: Schema.Attribute.Decimal & Schema.Attribute.Required;
    tributo_id: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    unidad_medida: Schema.Attribute.Enumeration<
      ['UND', 'KG', 'LB', 'MT', 'M2', 'M3', 'LT', 'GL', 'HR', 'DIA']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'UND'>;
...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    errores_factus: Schema.Attribute.JSON;
    es_instrumento_negociable: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    factus_qr_image: Schema.Attribute.Text;
    ...
    forma_pago: Schema.Attribute.Enumeration<
      ['Efectivo', 'Credito', 'Tarjeta', 'Transferencia', 'Cheque']
    >;
    ...
    > &
      Schema.Attribute.Private;
    medio_pago: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 50;
      }>;
    ...
    orden_compra_fecha: Schema.Attribute.Date;
    orden_compra_referencia: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    periodo_facturacion_fin: Schema.Attribute.DateTime;
    periodo_facturacion_inicio: Schema.Attribute.DateTime;
    ...
    subtotal: Schema.Attribute.Decimal & Schema.Attribute.Required;
    tiene_reclamo: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    tipo_operacion: Schema.Attribute.Enumeration<
      ['Venta', 'Credito', 'Contado', 'Exportacion']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Contado'>;
    total: Schema.Attribute.Decimal & Schema.Attribute.Required;
    total_descuentos: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    ...
    url_publica: Schema.Attribute.String;
    url_xml: Schema.Attribute.String;
  };
}

export interface ApiNumeringRangeNumeringRange
  extends Struct.CollectionTypeSchema {
  collectionName: 'numering_ranges';
  info: {
    displayName: 'numering_range';
    pluralName: 'numering-ranges';
    singularName: 'numering-range';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    desde: Schema.Attribute.Integer & Schema.Attribute.Required;
    factus_id: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    fecha_resolucion: Schema.Attribute.Date;
    fecha_vencimiento: Schema.Attribute.Date;
    hasta: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::numering-range.numering-range'
    ...
    publishedAt: Schema.Attribute.DateTime;
    resolucion_dian: Schema.Attribute.String & Schema.Attribute.Required;
    tipo_documento: Schema.Attribute.Enumeration<
      ['factura', 'nota_credito', 'nota_debito', 'factura_exportacion']
    > &
      Schema.Attribute.DefaultTo<'factura'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activo: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    aplica_ica: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    aplica_ico: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    aplica_iva: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    ...
    codigo_estandar_id: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<1>;
    codigo_unspsc: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 10;
      }>;
    createdAt: Schema.Attribute.DateTime;
    ...
    descripcion: Schema.Attribute.Text;
    esquema_id: Schema.Attribute.String & Schema.Attribute.DefaultTo<'1'>;
    ica_porcentaje: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::numering-range.numering-range': ApiNumeringRangeNumeringRange;
